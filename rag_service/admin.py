...
class CommunitySummaryAdmin(admin.ModelAdmin):
    list_display = ["start_date", "end_date", "topics_count", "recent_emails_count", "is_active", "need_review", "generated_at"]
    list_filter = ["is_active", "need_review", "generated_at"]
    ...
    mark_as_reviewed.short_description = "Mark selected summaries as reviewed"
    ...
    mark_as_needs_review.short_description = "Mark selected summaries as needing review"
